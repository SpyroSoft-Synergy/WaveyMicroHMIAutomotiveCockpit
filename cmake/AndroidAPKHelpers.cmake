# AndroidAPKHelpers.cmake - Android APK build helpers for Wavey project
#
# This module provides utility functions for Android APK builds.
...
function(finalize_android_dependencies TARGET)
  ...
  foreach(DEPENDENCY_TARGET ${_ANDROID_DEPNDECY_TARGETS})
    ...
    endforeach()
  endforeach()
  get_target_property(_QT_ANDROID_EXTRA_LIBS ${TARGET} QT_ANDROID_EXTRA_LIBS)
  set_target_properties(${TARGET} PROPERTIES QT_ANDROID_EXTRA_LIBS
                                             "${_EXTRA_ANDROID_LIBS};${_QT_ANDROID_EXTRA_LIBS}")
